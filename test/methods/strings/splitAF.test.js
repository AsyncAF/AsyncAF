...
describe('splitAF method', () => {
  const tests = [
    ...
    ['and split on multiple chars',
      's, p, l, a, t', [', '],
      ['s', 'p', 'l', 'a', 't']],
    ['and resolve to one element (the whole string) if no separator specified',
      'splatted', [],
      ['splatted']],
    ['and resolve to one element (the whole string) if separator not found',
      'splitAF', ['n/a'],
      ['splitAF']],
    ['and resolve to an array of characters when passed an empty string',
      'splatAF', [''],
      ['s', 'p', 'l', 'a', 't', 'A', 'F']],
    ...
    ['and limit should not affect result if end of string is reached first',
      'splatted ', [' ', 20],
      ['splatted', '']],
    ['and a limit of zero should resolve to an empty array',
      'stringystring', ['', 0],
      []],
